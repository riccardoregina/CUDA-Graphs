...
\end{itemize}
Configurations A and B correspond to the personal computing systems of the authors, whereas Configuration C was provisioned using the Google Colab cloud computing platform.
